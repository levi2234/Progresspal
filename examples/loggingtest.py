...
if __name__ == "__main__":
    ...
    for i in range(40):
        logger.INFO("Dit is een voorbeeld INFO bericht ")
        logger.DEBUG("Dit is een voorbeeld DEBUG bericht ")
        logger.INFO("Dit is een voorbeeld INFO bericht ")
        logger.DEBUG("Dit is een voorbeeld DEBUG bericht ")
        logger.LOG("Dit is een voorbeeld LOG bericht ")
        logger.CRITICAL("Dit is een voorbeeld CRITICAL bericht ")
        logger.ERROR("Dit is een voorbeeld ERROR bericht ")
        logger.WARNING("Dit is een voorbeeld WARNING bericht ")
        time.sleep(1)
