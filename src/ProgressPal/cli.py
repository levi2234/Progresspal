...
def CLI():
    ...
    parser.add_argument(
        "--host", type=str, default="127.0.0.1", help="Host name for the web server"
    )
    parser.add_argument(
        "--port", type=int, default=5000, help="Port number for the web server"
    )
    parser.add_argument("--debug", type=bool, default=False, help="Enable debug mode")
    parser.add_argument("--verbose", type=bool, default=True, help="Enable web log")
    parser.add_argument(
        "--lt_subdomain", type=str, default=None, help="Localtunnel subdomain"
    )
